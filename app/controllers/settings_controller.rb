class SettingsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @setting.update(setting_params)
        format.html { redirect_to @setting, notice: "Setting was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to settings_path, notice: "Setting was successfully destroyed.", status: :see_other }
